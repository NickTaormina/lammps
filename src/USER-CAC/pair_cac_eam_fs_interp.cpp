...
#include "pair_cac_eam_fs_interp.h"
#include <cstdio>
#include <cstdlib>
#include <cstring>
#include "atom.h"
...
PairCACEAMFSInterp::PairCACEAMFSInterp(LAMMPS *lmp) : PairCACEAMInterp(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
  he_flag = 0;
...
void PairCACEAMFSInterp::coeff(int narg, char **arg)
{
  int i,j;
...
void PairCACEAMFSInterp::read_file(char *filename)
{
  Fs *file = fs;
...
void PairCACEAMFSInterp::file2array()
{
  int i,j,m,n;
