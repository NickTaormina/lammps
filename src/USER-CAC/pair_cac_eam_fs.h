...
PairStyle(cac/eam/fs,PairCACEAMFS)

#else

#ifndef LMP_PAIR_CAC_EAM_FS_H
#define LMP_PAIR_CAC_EAM_FS_H
...
class PairCACEAMFS : virtual public PairCACEAM {
 public:
  PairCACEAMFS(class LAMMPS *);
  virtual ~PairCACEAMFS() {}
  void coeff(int, char **);
