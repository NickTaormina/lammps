...
DumpCACAtomFlux::~DumpCACAtomFlux()
{
...
int DumpCACAtomFlux::convert_string(int n, double *mybuf)
{
  int offset = 0;
  int m = 0;
  for (int i = 0; i < n; i++) {
...
void DumpCACAtomFlux::write_lines(int n, double *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
