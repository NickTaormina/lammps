...
PairCACEAMFS::PairCACEAMFS(LAMMPS *lmp) : PairCACEAM(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
  he_flag = 0;
...
void PairCACEAMFS::coeff(int narg, char **arg)
{
  int i,j;
...
void PairCACEAMFS::read_file(char *filename)
{
  Fs *file = fs;
